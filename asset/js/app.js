...
var Word = /** @class */ (function () {
    function Word(word, defintion, pictureUrl) {
        this.word = word;
...
var EmotionObject = /** @class */ (function () {
    function EmotionObject(emotion, description, color, onomatopoeia) {
     ...
     * @return Array
     */
    EmotionObject.prototype.getOnomatopoeiaWords = function () {
    };
    ;
    /**
     * コンテナのすべての文字列を取得
     * @rreturn string
     */
    EmotionObject.prototype.getHtmlContainerString = function () {
    };
...
categoryContets += '</ul>';
// 感情詳細のBody
var linkedContent = "<ul class='list-unstyled'>";
for (var i = 0; i < emotions.length; i++) {
    // 感情の詳細
    var onomatopoeiaContets = "<ul class='list-unstyled'>";
    for (var j = 0; j < emotions[i].onomatopoeia.length; j++) {
